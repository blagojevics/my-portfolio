    ...
    >
      <div className="grid md:grid-cols-2 gap-8 md:gap-12 items-start">
        ...
        <div className="flex flex-col gap-2.5">
          <h1 className="text-4xl sm:text-5xl font-extrabold text-[var(--text-color)] mb-1 flex flex-col gap-1">
            Hi, I&apos;m
            <span className="text-[var(--gradient-color)]">Stefan</span>
            <span className="text-[var(--gradient-color)]">Blagojević</span>
          </h1>
          <h2 className="text-[1.2rem] sm:text-2xl font-semibold text-[var(--text-color)] mb-2">
            Frontend Developer
          </h2>
          <h3 className="text-lg font-semibold text-[var(--text-color)] flex gap-1 items-center">
            <FaMapMarkerAlt
              className="text-2xl"
              style={{
                background:
